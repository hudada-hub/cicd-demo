...
function $c(e, n, t, r, l, u, o, i, s) {
  (Et = !1), (Tr = null), jc.apply(Uc, arguments);
}
...
function wr(e) {
  ...
  for (var n = e.targetContainers; 0 < n.length; ) {
    ...
    } else return (n = Zt(t)), n !== null && qu(n), (e.blockedOn = t), !1;
    n.shift();
  }
  return !0;
}
...
function Tf(e, n) {
  if (In)
    return e === "compositionend" || (!ro && js(e, n))
      ? ((e = Is()), (Sr = eo = en = null), (In = !1), e)
      : null;
  switch (e) {
    case "paste":
      return null;
...
function li() {
  xt && (xt.detachEvent("onpropertychange", Vs), (Ft = xt = null));
}
function Vs(e) {
  if (e.propertyName === "value" && rl(Ft)) {
    var n = [];
    $s(n, Ft, e, Gu(e)), Ss(Of, n);
  }
}
function Df(e, n, t) {
  e === "focusin"
    ? (li(), (xt = n), (Ft = t), xt.attachEvent("onpropertychange", Vs))
    : e === "focusout" && li();
}
function If(e) {
...
function vn() {
  if (!Fl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), xs(Zu, vn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function Ti(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    _r(e, n), Pa(n, t, r), xu(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function cd(e, n, t) {
  ...
  switch ((oo(n), n.tag)) {
        ...
        (e === null || e.child === null) &&
          (fr(n)
            ...
            : e === null ||
              ...
              ((n.flags |= 1024), Le !== null && (Uu(Le), (Le = null)))),
        Tu(e, n),
        ne(n),
        null
      );
    ...
    case 4:
      return (
        nt(), Tu(e, n), e === null && Ut(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Fe], delete n[At], delete n[gu], delete n[Gf], delete n[Zf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            ...
            e.timeoutHandle = yu(wn.bind(null, e, se, $e), n);
            break;
          }
          wn(e, se, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yu(wn.bind(null, e, se, $e), r);
            break;
          }
          wn(e, se, $e);
          break;
...
function Jr(e, n) {
  ...
  while (1);
  if ((ao(), (R = t), (Xr.current = r), Q !== null)) throw Error(y(261));
  return (Z = null), (q = 0), Y;
}
function yd() {
  for (; Q !== null; ) Ya(Q);
...
function wd(e, n, t, r) {
  ...
  if (Gr) throw ((Gr = !1), (e = Iu), (Iu = null), e);
  return (
    Zr & 1 && e.tag !== 0 && Zn(),
    (u = e.pendingLanes),
...
Za = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && ea(n, Vr, n.index);
...
function zr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == "function")) Lo(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Xl:
        return (
          (e = ke(12, t, n, l | 2)), (e.elementType = Xl), (e.lanes = u), e
        );
      case Gl:
        return (e = ke(13, t, n, l)), (e.elementType = Gl), (e.lanes = u), e;
      case Zl:
        return (e = ke(19, t, n, l)), (e.elementType = Zl), (e.lanes = u), e;
      case is:
        return fl(t, l, u, n);
      default:
...
gs = No;
ws = Ln;
var Ld = { usingClientEntryPoint: !1, Events: [Zt, Un, ul, hs, ys, No] },
  ht = {
...
var Ql = ({ children: e, onClick: n, variant: t = "primary" }) => {
  const r =
...
function Od() {
  ...
  return Ie.jsxs("div", {
    className:
      "min-h-screen bg-gray-100 flex flex-col items-center justify-center space-y-4",
    children: [
      Ie.jsx("h1", {
      ...
      Ie.jsxs("div", {
        className: "space-x-4",
        children: [
          Ie.jsx(Ql, { onClick: () => n(e - 1), children: "Decrement" }),
          Ie.jsx(Ql, { onClick: () => n(e + 1), children: "Increment" }),
          Ie.jsx(Ql, {
            variant: "secondary",
            onClick: () => n(0),
            children: "Reset",
